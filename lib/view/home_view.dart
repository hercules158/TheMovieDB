...
import 'package:movies/images/banner.jpg';
...
class _HomePageState extends State<HomePage> {
  ...
  updateHome() {
    setState(() {
      updateResponse = HomeRepository().fetch();
    });
  }
          ...
          if (snapshot.hasData) {
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                var img =
                    'https://image.tmdb.org/t/p/w400${snapshot.data![index]['poster_path']}';

                return Container(
                  decoration: const BoxDecoration(
                      border: Border(bottom: BorderSide(color: Colors.indigo))),
                  child: ListTile(
                    title: Text(
                      '$title',
                      textAlign: TextAlign.center,
